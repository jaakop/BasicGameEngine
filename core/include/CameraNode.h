...
public:
	...
	inline void SetProjectionParams(const glm::vec4& params) { SetProjectionParams(params.x, params.y, params.z, params.w); }

	inline glm::vec4 GetProjectionParams() const { return glm::vec4(m_fFov, m_fAscpect, m_fNearPlane, m_fFarPlane); }

	inline void SetAspect(float aspect) { SetProjectionParams(m_fFov, aspect, m_fNearPlane, m_fFarPlane); }
	...
	inline void SetProjectionMatric(const glm::mat4& m) { m_mProjection = m; }
